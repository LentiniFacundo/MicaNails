...
const Home = ({title, description}) => {
  return (
    <section id='home' className='flex flex-col justify-center items-center bgmh bg-no-repeat bg-cover bg-center m-4 w-full max-w-[1200px] h-[560px] bg-[#1b0d14] rounded-xl mb-15 shadow-2xl shadow-slate-500'>
        <div className='flex flex-col justify-center items-center gap-5'>
            ...
            <h2 className='text-4xl font-black text-white font-jakarta text-center
                md:text-6xl tracking-tight'>{title}</h2>
